...
create table Users (uid  serial primary key , username varchar(50), pass varchar(50), fname varchar(50), lname varchar(50), email varchar(100), affil varchar(250), phone varchar(50));
